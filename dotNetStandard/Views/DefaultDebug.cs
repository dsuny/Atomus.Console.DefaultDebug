...
namespace Atomus.Console
{
    public partial class DefaultDebug : IAction
    {
            ...
            try
            {
                ...
                switch (e.Action)
                {
                    case "start":
                        try
                        {
                            this.beforeActionEventHandler.Invoke(this, new AtomusPageEventArgs() { Action = "Login" });
                            this.beforeActionEventHandler.Invoke(this, new AtomusPageEventArgs() { Action = "AddUserControl" });
                        }
        ...
        private void UserControl_AfterActionEventHandler(ICore sender, AtomusPageEventArgs e)
        {
            object[] objects;
            ...
            try
            {
                switch (e.Action)
                {
                    case "UserControl.OpenControl" :
                        ...
                        this.OpenControl(this.menuDatabaseName, this.menuProcedureID,  (decimal)objects[0], (decimal)objects[1], null, sender, (objects[2] == null) ? null : (AtomusPageEventArgs)objects[2], true);
                    ...
                    case "UserControl.GetControl" :
                        ...
                        e.Value = this.OpenControl(this.menuDatabaseName, this.menuProcedureID, (decimal)objects[0], (decimal)objects[1], null, sender, (objects[2] == null) ? null : (AtomusPageEventArgs)objects[2], false);
                        break;
        ...
        private ICore OpenControl(string databaseName, string procedureID, decimal MENU_ID, decimal ASSEMBLY_ID, IAction core, ICore sender, AtomusPageEventArgs atomusControlEventArgs, bool addTabControl)
        {
            Service.IResponse result;
